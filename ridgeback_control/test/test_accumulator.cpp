...
#endif
#include <mecanum_drive_controller/rolling_mean_accumulator.h>
...
TEST(TestAccumulator, test_accumulator)
{
    ...
    mecanum_drive_controller::RollingMeanAccumulator<double> accum(4);
...
{
    constexpr double THRESHOLD = 1e-12;
    mecanum_drive_controller::RollingMeanAccumulator<double> accum(10);
