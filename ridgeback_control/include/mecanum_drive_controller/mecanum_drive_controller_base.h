...
#ifndef MECANUM_DRIVE_CONTROLLER__FORWARD_CONTROLLERS_BASE_HPP_
#define MECANUM_DRIVE_CONTROLLER__FORWARD_CONTROLLERS_BASE_HPP_
 ...
 */
class MecanumDriveControllerBase : public controller_interface::ControllerInterface
{
public:
    ...
    MECANUM_DRIVE_CONTROLLER_PUBLIC
    ~MecanumDriveControllerBase() = default;
...
#endif // MECANUM_DRIVE_CONTROLLER__FORWARD_CONTROLLERS_BASE_HPP_
